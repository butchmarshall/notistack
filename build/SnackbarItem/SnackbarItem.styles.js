...
var getTransitionStyles = exports.getTransitionStyles = function getTransitionStyles(offset, anchorOrigin) {
    var vertical = anchorOrigin.vertical !== "center" ? anchorOrigin.vertical : 'bottom';

    return Object.assign(_extends(_defineProperty({}, 'margin-' + vertical, offset), function () {
        if (anchorOrigin.horizontal !== 'center') {
            return _defineProperty({}, anchorOrigin.horizontal, 0);
        }
        return {};
    }(), function () {
        if (anchorOrigin.vertical !== 'center') {
            return _defineProperty({}, anchorOrigin.vertical, 0);
        }
        return {};
    }()), {
